...
public class HumanPagingService {
	 ...
	 * @param searcher функция поиска данных - принимает skip и take, а возвращает
	 * пару <массив жизнеописаний для отображения на странице, общее количество>
	 * @return
	 */
  public Page<Human> buildPage(Pageable page_info, 
	    BiFunction<Integer, Integer, Pair<Human[], Integer>> searcher)
	{
	  ...
	  Page<Human> humanPage = new PageImpl<Human>(Arrays.asList(humans),
	      PageRequest.of(pageNum, pageSize), humans_count);
